...
export default function ProfileContent() {
  ...
  const saveAddress = () => {
    ...
    if (!addrForm.name.trim()) errs.name = "Full name is required";
    if (!addrForm.street.trim()) errs.street = "Street address is required";
    if (!addrForm.city.trim()) errs.city = "City / postal code is required";
    ...
    const newAddr = {
      ...
      addr: addrForm.street.trim(),
      city: addrForm.city.trim(),
      def: addrForm.makeDefault || addresses.length === 0,
    };
    setAddresses((prev) => {
      const base = addrForm.makeDefault
        ? prev.map((a) => ({ ...a, def: false }))
        : prev;
      return [...base, newAddr];
    });
    setAddrForm({
          ...
          >
            ...
            >
                  ...
                  {["Home", "Office", "Other"].map((t) => (
                    <button
                      ...
                      style={{
                        ...
                        border: "1.5px solid",
                        borderColor:
                          addrForm.type === t ? "var(--teal)" : "#e2e8f0",
                        background:
                          addrForm.type === t ? "var(--teal-xs)" : "#fff",
                        color:
                          addrForm.type === t ? "var(--teal-dk)" : "#64748b",
                        fontWeight: addrForm.type === t ? 600 : 400,
                        fontSize: ".85rem",
                        cursor: "pointer",
                        transition: ".15s",
                        display: "flex",
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    setAddrErrors((v) => ({ ...v, name: "" }));
                  }}
                  placeholder="Recipient's full name"
                  style={{
                    borderColor: addrErrors.name ? "#ef4444" : undefined,
                  }}
                />
                {addrErrors.name && (
                  <p
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    setAddrErrors((v) => ({ ...v, street: "" }));
                  }}
                  placeholder="House number, street name, ward…"
                  style={{
                    borderColor: addrErrors.street ? "#ef4444" : undefined,
                  }}
                />
                {addrErrors.street && (
                  <p
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    setAddrErrors((v) => ({ ...v, city: "" }));
                  }}
                  placeholder="e.g. District 1, Ho Chi Minh City, 70000"
                  style={{
                    borderColor: addrErrors.city ? "#ef4444" : undefined,
                  }}
                />
                {addrErrors.city && (
                  <p
              ...
              <label
                style={{
                  ...
                  padding: ".75rem",
                  borderRadius: "0.75rem",
                  background: addrForm.makeDefault
                    ? "var(--teal-xs)"
                    : "#f8fafc",
                  border: `1.5px solid ${addrForm.makeDefault ? "var(--teal-lt)" : "#f1f5f9"}`,
                  transition: ".15s",
                }}
              >
                <input
            ...
            >
              ...
              <BtnOutline
                ...
                style={{ flex: 1, padding: "0.7rem" } as React.CSSProperties}
              >
                Cancel
              </BtnOutline>
            </div>
              ...
              >
                ...
                <div
                  style={{
                    ...
                    boxShadow: "0 4px 12px rgba(0,105,76,.25)",
                  }}
                >
                  {avatarUrl ? (
                    <img
                    ...
                    <div
                      style={{
                        width: "100%",
                        height: "100%",
                        background: "linear-gradient(135deg,#00694c,#003028)",
                        display: "flex",
                        alignItems: "center",
                        justifyContent: "center",
                        color: "#fff",
              ...
              {navItems.map((n) => (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: "0.75rem",
                    border: "none",
                    background: tab === n.id ? "var(--teal)" : "transparent",
              ...
              {!editing ? (
                ...
                >
                  ...
                  >
                    ...
                    <BtnOutline onClick={() => setEditing(false)}>
                      Cancel
                    </BtnOutline>
                  </div>
                </div>
                ...
                {notifOpts.map(([title, desc, checked], i) => (
                  <div
                    ...
                    style={{
                      ...
                      padding: "1rem 0",
                      borderBottom:
                        i < notifOpts.length - 1 ? "1px solid #f1f5f9" : "none",
                    }}
                  >
                    <div>
                      <p style={{ fontWeight: 500, fontSize: ".9rem" }}>
                        {title}
                      </p>
                      <p
                        style={{
