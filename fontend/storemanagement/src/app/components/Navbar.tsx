      ...
      >
        ...
        >
          <Image
            ...
            width={86}
            height={56}
            style={{ borderRadius: "0.7rem", display: "block" }}
          />
          <span
            style={{
              fontSize: "1.2rem",
        ...
        >
          ...
          {!user && (
            <>
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = "var(--teal-dk)";
                }}
                onMouseLeave={(e) => {
          ...
          {user && (
            ...
            >
              <span
                className="material-symbols-outlined"
                style={{ fontSize: "24px", color: "var(--teal-dk)" }}
              >
                shopping_bag
              </span>
              {cartCount > 0 && (
              ...
              {showDropdown && (
                ...
                >
                  ...
                  >
                    <span
                      className="material-symbols-outlined"
                      style={{ ...menuIconStyle, color: "#ef4444" }}
                    >
                      logout
                    </span>
                    Sign Out
