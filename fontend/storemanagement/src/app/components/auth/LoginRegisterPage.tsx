...
export default function LoginRegisterPage({ defaultTab = "login" }: Props) {
  ...
  const handleRegister = () => {
    if (!regName || !regPhone || !regPass || !regPass2) {
    ...
    setRegLoading(true);
    setTimeout(async () => {
      const result = await startRegister(regName, regPhone, regPass);
      setRegLoading(false);
      if (!result.success) {
    ...
    >
      ...
      <div
        style={{
          ...
          background:
            "linear-gradient(135deg,#00694c 0%,#004d38 60%,#003028 100%)",
          padding: "3rem",
          position: "relative",
          overflow: "hidden",
          minWidth: 0,
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            opacity: 0.07,
            backgroundImage: `url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='20' height='20'><circle cx='10' cy='10' r='1.5' fill='white'/></svg>")`,
          }}
        />
        <div
          style={{
        ...
        >
          ...
          >
            Fresh finds delivered daily. Home appliances, gourmet food & premium
            beauty products.
          </p>
        </div>
      </div>
      ...
      >
        <div style={{ width: "100%", maxWidth: 380 }}>
          ...
          {tab === "login" && (
            <div style={{ animation: "fadeIn .3s ease" }}>
              ...
              >
                Sign in to your Happy Market account
              </p>
              ...
              <div style={{ marginBottom: "1rem" }}>
                ...
                <input
                  ...
                  style={inputStyle}
                  onFocus={(e) => {
                    e.currentTarget.style.borderColor = "#00694c";
                    e.currentTarget.style.background = "#fff";
                  }}
                  onBlur={(e) => {
                    e.currentTarget.style.borderColor = "#c8e4d8";
              ...
              <div style={{ marginBottom: "0.5rem" }}>
                ...
                >
                  <label
                    style={{ fontSize: 12, fontWeight: 600, color: "#3d4943" }}
                  >
                    Password
                  </label>
                  <button
        ...
        >
          © 2025 Happy Market. All rights reserved.
        </p>
      </div>
