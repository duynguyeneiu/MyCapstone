...
export default function PromotionsPage({ activePage, onNav }: Props) {
    ...
    <div className="bg-background text-on-surface" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <aside className="h-screen w-64 fixed left-0 top-0 z-40 flex flex-col py-5 px-3 overflow-y-auto">
        <div className="mb-8 px-4">
          <h1 className="font-bold flex items-center" style={{ fontSize: '20px', lineHeight: '28px', color: '#00694c' }}>
            <span className="brand-dot"></span>RetailPro
          </h1>
          <p className="text-on-surface-variant" style={{ fontSize: '14px' }}>Management System</p>
        </div>
      ...
      <main className="ml-64 min-h-screen flex flex-col">
        <header className="sticky top-0 z-30 flex justify-between items-center px-8 py-4">
          <div className="flex items-center gap-4">
            <h2 className="font-bold" style={{ fontSize: '24px', color: '#00694c' }}>Promotions</h2>
            <div className="search-bar hidden lg:flex w-80">
              ...
              <input placeholder="Search code, description..." value={search} onChange={e => setSearch(e.target.value)} />
            </div>
          </div>
          <div className="flex items-center gap-3">
