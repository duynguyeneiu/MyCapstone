        ...
        <aside style={{ width: 232, flexShrink: 0 }}>
          <div style={{ background: '#fff', borderRadius: '1.25rem', padding: '1rem', boxShadow: '0 2px 12px rgba(0,0,0,.05)' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              ...
              <button onClick={() => router.push('/orders')} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '.6rem 1rem', borderRadius: '0.75rem', border: 'none', background: 'transparent', color: '#64748b', fontWeight: 500, fontSize: '.875rem', cursor: 'pointer', width: '100%', textAlign: 'left' }}>📦 Order History</button>
              <button onClick={() => router.push('/reviews')} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '.6rem 1rem', borderRadius: '0.75rem', border: 'none', background: 'transparent', color: '#64748b', fontWeight: 500, fontSize: '.875rem', cursor: 'pointer', width: '100%', textAlign: 'left' }}>⭐ My Reviews</button>
              <hr style={{ border: 'none', borderTop: '1px solid #f1f5f9', margin: '0.25rem 0' }} />
          ...
          {tab === 'info' && (
            <div style={{ background: '#fff', borderRadius: '1.25rem', padding: '1.5rem', boxShadow: '0 2px 10px rgba(0,0,0,.05)' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
                ...
                {!editing
                  ? <BtnOutline onClick={() => setEditing(true)}>✏️ Edit</BtnOutline>
